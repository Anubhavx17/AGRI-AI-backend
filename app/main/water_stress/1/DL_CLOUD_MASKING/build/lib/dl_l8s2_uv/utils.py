...
from app.main.water_stress.DL_CLOUD_MASKING.dl_l8s2_uv import model
...
CLOUD_DETECTION_WEIGHTS = {
    "rgbiswir": pkg_resources.resource_filename('dl_l8s2_uv', r'C:\Users\ANUBHAV\OneDrive\Desktop\AGRI_DCM\backend\app\main\water_stress\DL_CLOUD_MASKING\dl_l8s2_uv\weights\landsatbiomeRGBI6.hdf5'),
    "rgbi": pkg_resources.resource_filename('dl_l8s2_uv', r'C:\Users\ANUBHAV\OneDrive\Desktop\AGRI_DCM\backend\app\main\water_stress\DL_CLOUD_MASKING\dl_l8s2_uv\weights\landsatbiomeRGBISWIR7.hdf5')
}
...
def predictbypatches(pred_function, img_HWC, patchsize=1024, buffersize=16):
    ...
    mask_save_invalid = np.zeros(shape, dtype=bool)
