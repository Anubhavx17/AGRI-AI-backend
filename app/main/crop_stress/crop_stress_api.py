...
from app.main.crop_stress.crop_stress_DASH import main

crop_stress_bp = Blueprint('crop_stress_bp', __name__)
...
def run_model():
        ...
        if result_already_exists(data.get('date'), 'Crop Stress', data.get('project_id'), user_id):
                return jsonify({
